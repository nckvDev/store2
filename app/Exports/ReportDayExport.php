...
class ReportDayExport implements FromQuery, WithHeadings, WithMapping, WithColumnFormatting, ShouldAutoSize, WithStyles
{
    /**
    ...
    public function query()
    {
        ...
        return Borrow::query()->whereDate('created_at', $this->date)->orderBy('borrow_status', 'desc');
    }
