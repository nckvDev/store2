                ...
                <div class="card bg-secondary shadow">
                    <div class="card-body">
                        ...
                        @if(session('4yTlTDKu3oJOfzD_cart_items'))
                            ...
                            @endforeach
                        @endif
                        <form action="{{ route('personnel_borrow_disposable.list') }}" method="GET">
                            <h3>ประเภท</h3>
                            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table id="example" class="mt-3">
                                ...
                                @foreach ($disposables as $item)
                                    <tr>
                                        <form action="{{ route('personnel_borrow_disposable.add') }}" method="POST"
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        ...
                        <div class="container">
                            <div class="card">
                                <div class="card-body">
                                    <form action="{{ route('personnel_borrow_disposable.save') }}" method="post">
                                        @csrf
                                        <div class="table-responsive">
                                            <table id="myTable">
                                                <thead>
                                                ...
                                                @foreach ($cartItems as $item)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <form action="{{ route('personnel_borrow_disposable.update') }}"
                                                                  method="POST"
                                                                  enctype="multipart/form-data">
                                                                @csrf
                                                            </form>
                                                        ...
                                                        <td>
                                                            <form action="{{ route('personnel_borrow_disposable.remove') }}"
                                                                  method="POST"
                                                                  enctype="multipart/form-data">
                                                                @csrf
                                        ...
                                        <a class="btn btn-outline-danger btn-sm mt-4"
                                           href="{{ route('personnel_borrow_disposable.clear') }}"> ลบทั้งหมด </a>
