                ...
                <div class="card-body">
                    ...
                    <table id="example" class="mt-3">
                        <thead class="thead-light">
                            <tr>
                                <th>รหัสพัสดุ</th>
                                <th style="width:30%">ชื่อพัสดุ</th>
                                <th>รูปภาพ</th>
                                <th>จำนวน</th>
                                <th>เลือก</th>
                            </tr>
                        ...
                        <tbody id="datalist">
                            ...
                            <tr>
                                <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" value="1" name="price" readonly style="width: 60px">
                                    <td>
                            ...
                            <tr>
                                <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" value="{{ $item->id }}" name="price" readonly>
                                    <input type="hidden" value="{{ $item->image }}" name="image" width="50" height="50"
                                        readonly>
                                    <td>
                                        <input type="text" value="{{ $item->stock_amount }}" name="quantity" readonly>
                                    </td>
                                ...
                                <form action="{{ route('cart.save') }}" method="post">
                                    ...
                                    <table id="myTable">
                                        ...
                                        <tbody id="borrowItem">
                                            <tr>
                                                <td>
                                                    <input type="text" value="{{ $item->id }}" name="borrow_list_id[]"
