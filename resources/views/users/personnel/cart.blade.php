                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-5">
                                <div class="form-group">
                                    ...
                                    <input id="lname" type="text" name="lastname" value="{{ auth()->user()->lastname }}"
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <h3 class="mb-4 ml-4">{{ __('รายการพัสดุ') }}</h3>
                    </div>
                    <div class="container">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('cart.save') }}" method="post">
                                            ...
                                            <tr>
                                                ...
                                                <td class="flex">
                                                    <form action="{{ route('cart.update') }}" method="POST">
                                                        ...
                                                        <button type="submit" class="btn btn-warning btn-sm">แก้ไข
                                                        </button>
                                                    </form>
                                                </td>
                                                <td>
                                    ...
                                    <button class="btn btn-success btn-sm mt-4">ยืนยัน</button>
                                </form>
