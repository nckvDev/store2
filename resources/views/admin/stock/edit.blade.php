        ...
        <div class="row">
            <div class="col-xl-12">
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('stock') }}">อุปกรณ์</a></li>
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="mb-0 ml-4">{{ __('เพิ่มอุปกรณ์') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ url('/stock/update/'.$stocks->id) }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <div class="pl-lg-2">
                                <div class="row">
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            <label class="form-control-label"
                                                   for="stock_num">{{ __('รหัสอุปกรณ์') }}</label>
                                            <input type="text" name="stock_num"
                                                   value="{{ $stocks->stock_num }}"
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            <label class="form-control-label"
                                                   for="stock_name">{{ __('ชื่ออุปกรณ์') }}</label>
                                ...
                                <div class="row">
                                    <div class="col-xl-8">
                                        <div class="form-group">
                                            <label class="form-control-label"
                                                   for="image">{{ __('รูปภาพ') }}</label>
                                            <input type="file" name="image" value="{{ $stocks->image }}"
                                                   class="form-control form-control-alternative{{ $errors->has('image') ? ' is-invalid' : '' }}  placeholder="{{ __('ประเภท') }}" >
                                    ...
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            <label class="form-control-label"
                                                   for="position">{{ __('ตำแหน่ง') }}</label>
                                            <input type="text" name="position" value="{{ $stocks->position }}"
                                                   class="form-control form-control-alternative{{ $errors->has('position') ? ' is-invalid' : '' }}  placeholder="{{ __('ประเภท') }}" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            <label class="form-control-label"
                                                   for="type_id">{{ __('ประเภท') }}</label>
                                            <select class="form-control form-control-alternative{{ $errors->has('type_id') ? ' is-invalid' : '' }} " name="type_id">
                                                <option>เลือก...</option>
                                    ...
                                    <div class="col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="defective_stock" value="{{ $stocks->defective_stock }}"
                                                   class="form-control form-control-alternative{{ $errors->has('defective_stock') ? ' is-invalid' : '' }}  placeholder="{{ __('ประเภท') }}" >
