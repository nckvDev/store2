        ...
        <div class="row">
            <div class="col-xl-12 mb-4">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ url('/stock/update/'.$stocks->id) }}"
                            ...
                            <div class="pl-lg-2">
                                <div class="row">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="form-group">
                                            <label class="form-control-label"
                                                   for="stock_name">{{ __('ชื่อวัสดุ') }}</label>
                                    ...
                                    <div class="col-xl-8">
                                        <div class="form-group">
                                            ...
                                            <div class="align-center">
                                                <img src="{{ asset($stocks->image) }}" alt="" width="200px"
                                                     height="200px">
                                            </div>
                                        </div>
                                    </div>
...
{{--                                            {{ __('ประเภท') }}">--}}
                                            <label class="form-control-label" for="defective_stock">{{ __('สถานะ') }}</label>
                                            <select
                                                class="form-control form-control-alternative{{ $errors->has('defective_stock') ? ' is-invalid' : '' }} "
                                                name="defective_stock">
{{--                                                <option>เลือก...</option>--}}
                                                <option value="0" {{old('defective_stock', $stocks->defective_stock ) == "0" ? 'selected' : null}} >ปกติ</option>
                                                <option value="1" {{old('defective_stock', $stocks->defective_stock ) == "1" ? 'selected' : null}} >ชำรุด</option>
                                            </select>
