                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">รายการอุปกรณ์</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('add_stock') }}" class="btn btn-sm btn-primary">เพิ่มอุปกรณ์</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            ...
                                            <a class="dropdown-item" href="{{ url('/stock/delete/'.$row->id) }}">Delete</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
