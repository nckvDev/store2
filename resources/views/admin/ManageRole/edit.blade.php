                                ...
                                <div class="pl-lg-2">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-2">
                                            <div class="form-group">
                                                <label class="form-control-label"
                                                       for="prefix_id">{{ __('คำนำหน้า') }}</label>
                                                <select
                                        ...
                                        <div class="col-xl-4">
                                            <div class="form-group">
                                                <label class="form-control-label"
                                                       for="firstname">{{ __('ชื่อจริง') }}</label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-3">
                                            <div class="form-group">
                                                <label class="form-control-label"
                                                       for="department">{{ __('แผนก') }}</label>
{{--                                                <input type="text" name="department" value="{{ $users->department }}"--}}
{{--                                                       class="form-control">--}}
                                                <select class="form-control" name="department" id="department">
                                                    <option value="">-- เลือก --</option>
                                                    @foreach($departments as $row)
                                                        <option value="{{ $row->department_name }}"
                                                            {{ $row->department_name == $users->department ? 'selected' : '' }}>
                                                            {{ $row->department_name  }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                                ...
                                                <select class="form-control" name="group" id="group">
                                                    ...
                                                    @foreach($groups as $row)
                                                        <option value="{{ $row->group_name }}"
                                                            {{ $row->group_name == $users->group ? 'selected' : '' }}>
                                                            {{ $row->group_name  }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-xl-2">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" data-toggle="select" title="Simple select"
                                                        ...
                                                        name="role">
                                                    <option value="admin"
                                                            name="role" {{ $users->role == "admin" ? 'selected' : '' }}>
                                                        admin
                                                    </option>
                                                    <option value="personnel"
                                                            name="role" {{ $users->role == "personnel" ? 'selected' : '' }}>
                                                        personnel
                                                    </option>
                                                    <option value="student"
                                                            name="role" {{ $users->role == "student" ? 'selected' : '' }}>
                                                        student
                                                    </option>
                                                </select>
                                            </div>
