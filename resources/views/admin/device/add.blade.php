        ...
        <div class="row">
            <div class="col-xl-12">
                <nav aria-label="breadcrumb" role="navigation">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('device') }}">วัสดุ</a></li>
        ...
        <div class="row">
            <div class="col-xl-12 mb-4">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('addDevice') }}" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                            <div class="pl-lg-2">
                                <div class="row">
                                    <div class="col-xl-2">
                                        <div class="form-group">
                                            <label class="form-control-label"
                                                   for="device_num">{{ __('รหัสวัสดุ') }}</label>
                                            <input type="text" name="device_num"
                                                   value="{{ old('device_num') ? old('device_num') : '' }}"
                                                   class="form-control form-control-alternative{{ $errors->has('device_num') ? ' is-invalid' : '' }} " autofocus>
